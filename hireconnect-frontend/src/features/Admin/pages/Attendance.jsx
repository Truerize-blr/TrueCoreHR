...
//     console.log("Attendance employees raw:", data);
...
//       console.log("Attendance stats raw:", res.data);
//       const data = res.data?.data ?? res.data;
//       setStats(normalizeStats(data || {}));
//     } catch (err) {
//       console.error("Error fetching attendance stats", err);
//       setStatsError("Failed to load attendance summary");
//       setStats((prev) => ({ ...prev, totalEmployees: prev.totalEmployees || 0 }));
//     } finally {
...
//     await axios.post(
//       `${API_BASE_URL}/api/admin/attendance/assign`,
//       payload,
...
//       // after assigning, refresh stats and list
//       fetchEmployees();
//       fetchStats();
//     } catch (err) {
...
//                        focus:ring-2 focus:ring-[#00008B] outline-none"
//             value={searchQuery}
...
//           <span>
//             On Break:{" "}
//             {filteredEmployees.filter((e) => e.status === "On Break").length}
//           </span>
...
//           <div>
//             <h2 className="text-lg font-semibold" style={{ color: primaryBlue }}>
//               Assign Attendance to Employees
//             </h2>
//             <p className="text-xs text-gray-500 mt-1">
//               Search and select an employee to assign attendance
//             </p>
//           </div>
//           <input
//             type="text"
...
//             className="px-3 py-2 border border-gray-300 rounded-lg text-sm
//                        focus:ring-2 focus:ring-[#00008B] outline-none w-full md:w-64"
//           />
//         </div>
...
//                            bg-[#00008B] text-white hover:bg-blue-900"
...
//               >
//                 Assign Attendance to {selectedEmployee?.name}
//               </h3>
...
//                     }
//                     className="w-full px-3 py-2 border border-gray-300 rounded-lg
//                                focus:ring-2 focus:ring-[#00008B] outline-none resize-none text-sm"
//                     placeholder="Reason for this attendance assignment…"
//                   />
//                 </div>
//               </div>
...
//                 </button>
//                 <button
//                   className="px-4 py-2 rounded-lg bg-[#00008B] text-white font-medium hover:bg-blue-900 disabled:opacity-60"
...
//           {[ // These are configuration toggles; usually static even in real apps
//             {
...
//               Time Zone
//             </h4>
//             <select className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#00008B] outline-none">
...
//             Monitor real-time attendance, manage leaves, assign corrections, and
//             configure policies in one place.
//           </p>
//         </div>
